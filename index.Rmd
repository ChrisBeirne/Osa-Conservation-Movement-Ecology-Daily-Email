...
ncol(check_in_summary)
check_in_summary[,c(1,2,3,5,6,7,13 )] %>%
  kbl() %>%
  kable_styling()  %>%
...
tmp2[, c("local_identifier", "timestamp_end", "days_since_check_in")] %>%
  kbl() %>%
  kable_styling()
