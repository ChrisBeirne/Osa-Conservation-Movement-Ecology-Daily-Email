...
{
  check_in_concern[[1]] <- data.frame(name=tmp_check,reason="Last checkin >8 days")
...
Their maximum movement step is below 100m OR their sum of movements is very low: 
