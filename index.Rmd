...
# Add the location data
dat <- left_join(dat, ec_animals[, c("tag_id", "animalName")])
# Sort the names out

dat$animalName <- sub('\\_.*', '', dat$animalName)
# Add in the taxonomic group
dat$animalName <- paste0(dat$animalName, "_", sub('\\ .*', '', dat$taxon_canonical_name))
ec_animals$animalName <- paste0(sub('\\_.*', '', ec_animals$animalName), "_", sub('\\ .*', '', ec_animals$taxon_canonical_name))
...
# add distance move last_24
check_in_summary$dist_km_last_24h <- dist_24$dist_km_last_24h
